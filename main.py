...
def create_args_for_experiment(pred_len, model_name="PaiFilter"):
    """Create arguments for a specific experiment configuration"""
    ...
    parser.add_argument(
        "--model_id", type=str, default=f"ETTm1_96_{pred_len}", help="model id"
    )
    parser.add_argument(
        "--model",
        type=str,
        default=model_name,
        help="model name, options: [PaiFilter, TexFilter]",
    )
    ...
    parser.add_argument(
        "--target", type=str, default="1", help="target feature in S or MS task"
    )
    parser.add_argument(
        "--freq",
        type=str,
    ...
    parser.add_argument(
        "--pred_len", type=int, default=pred_len, help="prediction sequence length"
    )
    parser.add_argument(
